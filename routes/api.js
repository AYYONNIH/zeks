...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('REST API BETA OM') // boleh diubah
}
...
var creator = 'Ayyon' // ubah jadi nama lu
const listkey = ["Alphabot","Zeeone","ZeeoneOfc","Ayyong"]; // ubah apikey nya, tambah aja klo mau
